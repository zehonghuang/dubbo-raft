...
public class UniqueIdUtil {
    ...
    public static String generateId() {
        return getId(IP_16, System.nanoTime(), getNextId());
    }
    ...
    private static int getProcessId() {
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Could not invoke ManagementFactory.getRuntimeMXBean().getName(), {}.", t.fillInStackTrace());
            }
        }
    ...
    public static void main(String[] args) {
        System.out.println(UniqueIdUtil.generateId());
    }
}
