...
public final class LogOutter {
  ...
  public  static final class LogEntry extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return LogOutter.internal_static_LogEntry_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return LogOutter.internal_static_LogEntry_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              LogOutter.LogEntry.class, LogOutter.LogEntry.Builder.class);
    }
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        for (int i = 0; i < peers_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeBytesSizeNoTag(peers_.get(i));
        }
        size += dataSize;
      ...
      }
      {
        ...
        for (int i = 0; i < oldPeers_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeBytesSizeNoTag(oldPeers_.get(i));
        }
        size += dataSize;
      ...
      }
      {
        ...
        for (int i = 0; i < learners_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeBytesSizeNoTag(learners_.get(i));
        }
        size += dataSize;
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof LogOutter.LogEntry)) {
        return super.equals(obj);
      }
      LogOutter.LogEntry other = (LogOutter.LogEntry) obj;
    ...
    public static LogOutter.LogEntry parseFrom(
    ...
    public static LogOutter.LogEntry parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static LogOutter.LogEntry parseFrom(
    ...
    public static LogOutter.LogEntry parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static LogOutter.LogEntry parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static LogOutter.LogEntry parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(LogOutter.LogEntry prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.hongframe.raft.entity.codec.proto.LogOutter.LogEntry.newBuilder()
      private Builder() {
      ...
      public LogOutter.LogEntry getDefaultInstanceForType() {
        return LogOutter.LogEntry.getDefaultInstance();
      }

      public LogOutter.LogEntry build() {
        LogOutter.LogEntry result = buildPartial();
      ...
      public LogOutter.LogEntry buildPartial() {
        LogOutter.LogEntry result = new LogOutter.LogEntry(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof LogOutter.LogEntry) {
          return mergeFrom((LogOutter.LogEntry)other);
        } else {
      ...
      public Builder mergeFrom(LogOutter.LogEntry other) {
        if (other == LogOutter.LogEntry.getDefaultInstance()) return this;
        if (other.hasType()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        LogOutter.LogEntry parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (LogOutter.LogEntry) e.getUnfinishedMessage();
  ...
  ensureOldLearnersIsMutable();
    ...
    private static final LogOutter.LogEntry DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new LogOutter.LogEntry();
    }

    public static LogOutter.LogEntry getDefaultInstance() {
  ...
  static {
    String[] descriptorData = {
      ...
      "hecksum\030\007 \001(\003\022\020\n\010learners\030\010 \003(\014\022\024\n\014old_l" +
      "earners\030\t \003(\014B2\n%com.hongframe.raft.enti" +
      "ty.codec.protoB\tLogOutter"
    };
    ...
    internal_static_LogEntry_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_LogEntry_descriptor,
        new String[] { "Type", "Term", "Index", "Peers", "OldPeers", "Data", "Checksum", "Learners", "OldLearners", });
  }
